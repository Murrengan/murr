...
urlpatterns = [
    ...
    path('murr_detail/comment_cut.ajax/<int:id>/', murr_card.comment_cut, name='comment_cut.ajax'),
    path('murr_detail/comment_edit.ajax/<int:id>/', murr_card.comment_edit, name='comment_edit.ajax'),
