...
from Murr_card.views import (murr_list, murr_detail, search, murr_update, murr_delete, murr_create,
                             comment_cut, comment_edit)
...
urlpatterns = [
    ...
    path('murr_detail/<str:slug>/comment_cut.ajax/<int:id>/', comment_cut, name='comment_cut.ajax'),
    path('murr_detail/<str:slug>/comment_edit.ajax/<int:id>/', comment_edit, name='comment_edit.ajax'),
